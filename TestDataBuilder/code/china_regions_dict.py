...
addr = {
    ...
    '河北省': {
        ...
        '石家庄市': ['长安区', '长安区', '桥西区', '新华区', '井陉矿区', '裕华区', '藁城区', '鹿泉区', '栾城区', '井陉县', '正定县', '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县', '无极县', '平山县', '元氏县', '赵县', '辛集市', '晋州市', '新乐市'],

        '唐山市': ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '曹妃甸区', '滦县', '滦南县', '乐亭县', '迁西县', '玉田县', '遵化市', '迁安市'],

        '秦皇岛市': ['海港区', '山海关区', '北戴河区', '抚宁区', '青龙县', '昌黎县', '卢龙县'],
        ...
        '承德市': ['双桥区', '双滦区', '鹰手营子', '承德县', '兴隆县', '平泉县', '滦平县', '隆化县', '丰宁县', '宽城县', '围场县'],
    ...
    '内蒙古': {
        ...
        '包头市': ['东河区', '昆都仑区', '青山区', '石拐区', '白云鄂博矿区', '九原区', '土默特右旗', '固阳县', '达茂联合旗'],

        '乌海市': ['海勃湾区', '海南区', '乌达区'],

        '赤峰市': ['红山区', '元宝山区', '松山区', '阿鲁科尔沁旗', '巴林左旗', '巴林右旗', '林西县', '克什克腾旗', '翁牛特旗', '喀喇沁旗', '宁城县', '敖汉旗'],

        '通辽市': ['科尔沁区', '科左中旗', '科左后旗', '开鲁县', '库伦旗', '奈曼旗', '扎鲁特旗', '霍林郭勒市'],

        '鄂尔多斯市': ['东胜区', '达拉特旗', '准格尔旗', '鄂托克前旗', '鄂托克旗', '杭锦旗', '伊金霍洛旗'],

        '呼伦贝尔市': ['海拉尔区', '扎赉诺尔区', '阿荣旗', '莫力达瓦旗', '鄂伦春旗', '鄂温克旗', '陈巴尔虎旗', '新左旗', '新右旗', '满洲里市', '牙克石市', '扎兰屯市', '额尔古纳市', '根河市'],

        '巴彦淖尔市': ['临河区', '五原县', '磴口县', '乌拉特前旗', '乌拉特中旗', '乌拉特后旗', '杭锦后旗'],

        '乌兰察布市': ['集宁区', '卓资县', '化德县', '商都县', '兴和县', '凉城县', '察右前旗', '察右中旗', '察右后旗', '四子王旗', '丰镇市'],

        '兴安盟': ['乌兰浩特市', '阿尔山市', '科右前旗', '科右中旗', '扎赉特旗', '突泉县'],

        '锡林郭勒盟': ['二连浩特市', '锡林浩特市', '阿巴嘎旗', '苏尼特左旗', '苏尼特右旗', '东乌旗', '西乌旗', '太仆寺旗', '镶黄旗', '正镶白旗', '正蓝旗', '多伦县'],
    ...
    '辽宁省': {
        ...
        '抚顺市': ['新抚区', '东洲区', '望花区', '顺城区', '抚顺县', '新宾县', '清原县'],

        '本溪市': ['平山区', '溪湖区', '明山区', '南芬区', '本溪县', '桓仁县'],

        '丹东市': ['元宝区', '振兴区', '振安区', '宽甸县', '东港市', '凤城市'],

        '锦州市': ['古塔区', '凌河区', '太和区', '黑山县', '义县', '凌海市', '北镇市'],

        '营口市': ['站前区', '西市区', '鲅鱼圈区', '老边区', '盖州市', '大石桥市'],

        '阜新市': ['海州区', '新邱区', '太平区', '清河门区', '细河区', '阜新县', '彰武县'],
        ...
        '朝阳市': ['双塔区', '龙城区', '朝阳县', '建平县', '喀左县', '北票市', '凌源市'],
    ...
    '吉林省': {
        ...
        '四平市': ['铁西区', '铁东区', '梨树县', '伊通县', '公主岭市', '双辽市'],

        '辽源市': ['龙山区', '西安区', '东丰县', '东辽县'],

        '通化市': ['东昌区', '二道江区', '通化县', '辉南县', '柳河县', '梅河口市', '集安市'],

        '白山市': ['浑江区', '江源区', '抚松县', '靖宇县', '长白县', '临江市'],

        '松原市': ['宁江区', '前郭县', '长岭县', '乾安县', '扶余市'],
    ...
    '黑龙江省': {
        ...
        '': ['阿城区', '双城区', '依兰县', '方正县', '宾县', '巴彦县', '木兰县', '通河县', '延寿县', '尚志市', '五常市'],

        '齐齐哈尔市': ['龙沙区', '建华区', '铁锋区', '昂昂溪区', '富拉尔基区', '碾子山区', '梅里斯区'],

        '': ['龙江县', '依安县', '泰来县', '甘南县', '富裕县', '克山县', '克东县', '拜泉县', '讷河市'],
    ...
    '广东省': {
        ...
        '江门市': ['蓬江区', '江海区', '台山市', '新会区', '开平市', '鹤山市', '恩平市'],
    ...
    '广西': {
        ...
        '柳州市': ['城中区', '鱼峰区', '柳南区', '柳北区', '柳江区', '柳城县', '鹿寨县', '融安县', '融水县', '三江县'],

        '桂林市': ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '临桂区', '阳朔县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '龙胜县', '资源县', '平乐县', '荔浦县', '恭城县'],
        ...
        '百色市': ['右江区', '田阳县', '田东县', '平果县', '德保县', '那坡县', '凌云县', '乐业县', '田林县', '西林县', '隆林县', '靖西市'],

        '贺州市': ['八步区', '昭平县', '钟山县', '富川县'],

        '河池市': ['金城江区', '宜州区', '南丹县', '天峨县', '凤山县', '东兰县', '罗城县', '环江县', '巴马县', '都安县', '大化县'],

        '来宾市': ['兴宾区', '忻城县', '象州县', '武宣县', '金秀县', '合山市'],
    ...
    '重庆市': {
        ...
        '重庆市': ['渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '渝北区', '巴南区', '万州区', '涪陵区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '綦江区', '大足区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区', '城口县', '丰都县', '垫江县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱县', '秀山县', '酉阳县', '彭水县']
    ...
    '云南省': {
        ...
        '红河州': ['个旧市', '开远市', '蒙自市', '弥勒市', '屏边县', '建水县', '石屏县', '泸西县', '元阳县', '红河县', '金平县', '绿春县', '河口县'],
    ...
    '甘肃省': {
        ...
        '天水市': ['秦州区', '麦积区', '清水县', '秦安县', '甘谷县', '武山县', '张家川县'],

        '武威市': ['凉州区', '民勤县', '古浪县', '天祝县'],

        '张掖市': ['甘州区', '肃南县', '民乐县', '临泽县', '高台县', '山丹县'],

        '平凉市': ['崆峒区', '泾川县', '灵台县', '崇信县', '华亭县', '庄浪县', '静宁县'],

        '酒泉市': ['肃州区', '金塔县', '瓜州县', '肃北县', '阿克塞县', '玉门市', '敦煌市'],
    ...
    '青海省': {
        ...
        '西宁市': ['城东区', '城中区', '城西区', '城北区', '大通县', '湟中县', '湟源县'],
    ...
    '新疆': {
        ...
        '克拉玛依市': ['克拉玛依', '独山子区', '克拉玛依区', '白碱滩区', '乌尔禾区'],

        '吐鲁番市': ['高昌区', '鄯善县', '托克逊县'],

        '哈密市': ['伊州区', '巴里坤县', '伊吾县'],

        '昌吉州': ['昌吉市', '阜康市', '呼图壁县', '玛纳斯县', '奇台县', '吉木萨尔县', '木垒县'],

        '博尔塔拉州': ['博乐市', '阿拉山口市', '精河县', '温泉县'],

        '巴音郭楞州': ['库尔勒市', '轮台县', '尉犁县', '若羌县', '且末县', '焉耆县', '和静县', '和硕县', '博湖县'],
        ...
        '伊犁州': ['伊宁市', '奎屯市', '霍尔果斯市', '伊宁县', '察布查尔县', '霍城县', '巩留县', '新源县', '昭苏县', '特克斯县', '尼勒克县'],

        '塔城地区': ['塔城市', '乌苏市', '额敏县', '沙湾县', '托里县', '裕民县', '和布克赛尔县'],

        '阿勒泰地区': [' 阿勒泰市', '布尔津县', '富蕴县', '福海县', '哈巴河县', '青河县', '吉木乃县'],

        '自治区直辖': ['石河子市', '阿拉尔市', '图木舒克市', '五家渠市', '北屯市', '铁门关市', '双河市', '可克达拉市'],
...
def regions():
    ...
    t = list(addr[province])
    city = random.choice(t)

    d = list(addr[province][city])
    district = random.choice(d)
